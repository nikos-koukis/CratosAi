module jarvis.internal/app-api

go 1.27

// Generated protobuf code and shared libraries live in this repo; resolve
// them locally even outside the Go workspace (e.g. `go mod tidy`).
replace (
