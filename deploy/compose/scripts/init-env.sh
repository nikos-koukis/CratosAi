...
SECRETS=(POSTGRES_PASSWORD VAULT_DB_PASSWORD MCP_DB_PASSWORD ORCH_DB_PASSWORD APP_DB_PASSWORD DASHBOARD_DB_PASSWORD DRAGONFLY_PASSWORD NEO4J_PASSWORD QDRANT_API_KEY)
