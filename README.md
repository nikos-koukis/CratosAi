...
pnpm nx run dashboard:serve   # run the web dashboard on http://localhost:3000 (needs the Vault and the app API)
pnpm nx run dashboard:e2e     # browser test of the dashboard against the running stack
